...
public class JpaUtil {
     ...
     */
    private static boolean JPAUTIL_LOG = true;
    ...
    /**
     * Méthode pour déasactiver l'affichage du Log.
     */    
    ...
    public static synchronized void creerFabriquePersistance() {
        ...
        //propertyMap.put(PersistenceUnitProperties.LOGGING_LEVEL, Level.OFF.toString());
